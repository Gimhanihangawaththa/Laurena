...
function AppHero() {
  ...
  useEffect(() => {
    // Fetch hero images from backend (or localStorage for demo)
    const data = JSON.parse(localStorage.getItem("heroData")) || [
      // default fallback data
      {
        ...
        title: "Timeless Elegance, Sparkling Forever",
        description:
          "Explore our exquisite collection of jewellery that blends tradition with modern artistry perfect for every occasion and every you.",
